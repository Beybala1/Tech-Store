    ...
    <div class="container">
        <nav>
            <ul id="menu-top-bar-left" class="nav nav-inline pull-left animate-dropdown flip">
                <li class="menu-item animate-dropdown"><a title="@lang("messages.bestStore")" href="#">@lang("messages.bestStore")</a></li>
            </ul>
        </nav>
        <nav>
                ...
                <li class="menu-item animate-dropdown">
                    ...
                    @else
                        <a href="{{ route("my-account.index") }}">
                            ...
                            @lang('messages.myAccount')
                        </a>
                    @endauth
                </li>
                @foreach(lang() as $lang)
                    <li class="menu-item animate-dropdown"><a href="{{ LaravelLocalization::getLocalizedURL($lang->code) }}">
                            <i style="border-radius: 50%;" class="fi fi-{{$lang->code}} fis fs-4 me-1"></i>
                @endforeach
            </ul>
        </nav>
    </div>
...
<header id="masthead" class="site-header header-v2">
    <div class="container hidden-md-down">
        <div class="row">
            ...
            <!-- ============================================================= Header Logo : End============================================================= -->
            @include("frontend.include.menus")
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <span class="support-number">
                            <strong>@lang("messages.support")</strong>
                            <a href="tel:{{$contact_phone->description}}">
                                {{$contact_phone->description}}
                            </a>
                        </span>
                        <br/>
                        <span class="support-email"><strong>@lang("messages.email"):</strong>
                            <a href="mailto:{{$contact_email->description}}">
