...
@endsection
<div class="card">
    <h5 class="card-header">@lang('messages.social')</h5>
    <div class="container">
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <form action="{{ route('social-status', $social->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="checkbox" name="status" {{ $social->status == 1 ? 'checked' : '' }}
                                ...
                                <form action="{{ route('social.destroy', $social->id) }}" method="post">
                                    ...
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('social.edit', $social->id) }}">
